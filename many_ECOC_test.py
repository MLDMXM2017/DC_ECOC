...
from Common import Read_Write_tool
...
if __name__ == '__main__':
    ...
    logging.basicConfig(filename='UCI_other_ECOC_log.txt', level=logging.DEBUG, format=LOG_FORMAT)
    ...
    UCI_dataname = ['car', 'cleveland', 'dermatology','isolet', 'led7digit' \
    ...
    data_folder_path = 'E:/workspace/pycharm/UCI/FS_data/'
    matrix_folder_path = 'E:/workspace/pycharm/UCI/DC_matrix/'
    res_folder_path = 'E:/workspace/pycharm/UCI/ECOC_backup/'

    selected_dataname = UCI_dataname[7:]
    selected_ecoc_name = other_ECOC[5:]
